<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center w-60">
                    <a href="{{ route('user.recipients.index') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('user.functions.index')" :active="request()->routeIs('user.functions.index')">
                        各種機能
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('user.recipients.index')" :active="request()->routeIs('user.recipients.index')">
                児童扶養手当
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('user.special_recipients.index')" :active="request()->routeIs('user.special_recipients.index')">
                特別児童扶養手当
            </x-responsive-nav-link>
        </div>
