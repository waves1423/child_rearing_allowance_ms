                ...
                <div class="lg:w-10/12 md:w-2/3 mx-auto">
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-full flex justify-around mt-4">
                      ...
                      <button type="button" onclick="location.href='{{ route('admin.recipients.spouses.calculations.edit', ['recipient' => $recipient->id,'spouse' => $recipient->spouse->id, 'calculation' => $recipient->spouse->calculation->id]) }}'" class=" bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">所得計算</button>
                      @else
                ...
                <div class="lg:w-10/12 md:w-2/3 mx-auto">
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-full flex justify-around mt-4">
                      ...
                      <button type="button" onclick="location.href='{{ route('admin.recipients.obligors.calculations.edit', ['recipient' => $recipient->id, 'obligor' => $recipient->obligor->id, 'calculation' => $recipient->obligor->calculation->id]) }}'" class=" bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">所得計算</button>
                      @else
