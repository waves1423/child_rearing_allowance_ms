<x-app-layout>
    ...
    <div class="py-8">
      ...
      <form method="POST" action="{{ route('admin.recipients.obligors.calculations.store', ['recipient' => $recipient->id, 'obligor' => $recipient->obligor->id]) }}">
        @csrf
