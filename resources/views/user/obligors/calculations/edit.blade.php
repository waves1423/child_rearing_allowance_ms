<x-app-layout>
    ...
    <div class="py-8">
      ...
      <form method="POST" action="{{ route('user.recipients.obligors.calculations.update', ['recipient' => $recipient->id, 'obligor' => $recipient->obligor->id, 'calculation' => $recipient->obligor->calculation->id]) }}">
        @csrf
        @method('put')
