<x-app-layout>
    ...
    <div class="py-8">
      ...
      <form method="POST" action="{{ route('user.recipients.spouses.calculations.update', ['recipient' => $recipient->id, 'spouse' => $recipient->spouse->id, 'calculation' => $recipient->spouse->calculation->id]) }}">
        @csrf
        @method('put')
